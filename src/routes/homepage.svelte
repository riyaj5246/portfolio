...
<div class="flex flex-row items-center w-full h-full">
    ...
    <div class="lg:basis-5/12 h-full basis-11/12">
        ...
        <div class="flex flex-row">
            <button type="button" onclick="window.location.href='https://github.com/riyaj5246';" target="_blank" rel="noreferrer" class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-1 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-700 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center mr-2">
